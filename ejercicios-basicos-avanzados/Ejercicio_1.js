...
let altura = "5";
let longitud = "10";
let suma = Number(altura) + Number(longitud)

console.log("mi super heroe favorito es " + miSuperheroeFavorito + " ,mi numero favorito es " + numeroFavorito + " ,la altura es " + altura + " ,la longitud es " + longitud + " y la suma de las dos es " + suma)
